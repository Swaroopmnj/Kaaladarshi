...
export const ACTIVITIES: ActivityDef[] = [
  ...
  { key: 'grihaPravesh', label: 'Griha Pravesh (new house — first entry)' },
  { key: 'houseShifting', label: 'House Shifting (rented, or between owned houses)' },
  { key: 'bhoomiPuja', label: 'Bhoomi Puja (Foundation laying)' },
  { key: 'homeBuying', label: 'Home Buying — Registration / Sale Deed' },
  { key: 'advancePayment', label: 'Advance / Token Payment (any purchase)' },
  { key: 'agreementSigning', label: 'Agreement Signing (any purchase)' },
  { key: 'namakarana', label: 'Namakarana (Naming ceremony)' },
  { key: 'vidyarambh', label: 'Vidyarambha (Starting education)' },
  { key: 'vahanKharidi', label: 'Vahan Kharidi (Vehicle delivery/possession)' },
  ...
  { key: 'garbhadhana', label: 'Garbhadhana / Nishekam (First union)' },
